		...
		bankChargesButton.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent ae) {
				...
				if (customerList.isEmpty()) {
					JOptionPane.showMessageDialog(mainFrame, "There are no customers yet!", "Oops!",
					...
					while (loop) {
						Object customerID = JOptionPane.showInputDialog(mainFrame,
								...
								continueButton.addActionListener(new ActionListener() {
									public void actionPerformed(ActionEvent ae) {
										...
										if (acc instanceof CustomerDepositAccount) {
											...
											JOptionPane.showMessageDialog(mainFrame, "New balance = " + acc.getBalance(),
							...
							if (customer.getAccounts().isEmpty()) {
								...
								continueButton.addActionListener(new ActionListener() {
									public void actionPerformed(ActionEvent ae) {
										...
										while (loop) {
											String interestString = JOptionPane.showInputDialog(mainFrame,
											...
											if (isNumeric(interestString)) {
												...
												JOptionPane.showMessageDialog(mainFrame, "You must enter a numerical value!",
														"Oops!", JOptionPane.INFORMATION_MESSAGE);
											}
					...
					while (loop) {
						...
						if (found == false) {
							...
							if (account.equals("Deposit Account")) {
								...
								JOptionPane.showMessageDialog(mainFrame, "Account number = " + number, "Account created.",
										JOptionPane.INFORMATION_MESSAGE);
				...
				} else {
					{
						...
						if (found == false) {
							...
							if (customer.getAccounts().size() > 0) {
								...
								JOptionPane.showMessageDialog(mainFrame, "Customer Deleted ", "Success.",
										JOptionPane.INFORMATION_MESSAGE);
							}
						}
